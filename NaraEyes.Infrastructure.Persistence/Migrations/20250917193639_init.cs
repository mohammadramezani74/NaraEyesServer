...
namespace NaraEyes.Infrastructure.Persistence.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SupervisionStates",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    Code = table.Column<int>(type: "int", unicode: false, maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupervisionStates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupervisionStates_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupervisionStates_AspNetUsers_ModifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Branches_SupervisionStates_SupervisionId",
                        column: x => x.SupervisionId,
                        principalTable: "SupervisionStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Branches_CreateDate",
                table: "Branches",
                column: "CreateDate");

            migrationBuilder.CreateIndex(
                name: "IX_Branches_CreatedByUserId_ModifiedById_Deleted",
                table: "Branches",
                columns: new[] { "CreatedByUserId", "ModifiedById", "Deleted" });

            migrationBuilder.CreateIndex(
                name: "IX_Branches_Deleted",
                table: "Branches",
                column: "Deleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Branches_SupervisionId",
                table: "Branches",
                column: "SupervisionId");

            migrationBuilder.CreateIndex(
                name: "IX_SupervisionStates_Code",
                table: "SupervisionStates",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SupervisionStates_CreateDate",
                table: "SupervisionStates",
                column: "CreateDate");

            migrationBuilder.CreateIndex(
                name: "IX_SupervisionStates_CreatedByUserId_ModifiedById_Deleted",
                table: "SupervisionStates",
                columns: new[] { "CreatedByUserId", "ModifiedById", "Deleted" });

            migrationBuilder.CreateIndex(
                name: "IX_SupervisionStates_Deleted",
                table: "SupervisionStates",
                column: "Deleted");

            migrationBuilder.CreateIndex(
                name: "IX_SupervisionStates_ModifiedById",
                table: "SupervisionStates",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_SupervisionStates_Name",
                table: "SupervisionStates",
                column: "Name");
        }
